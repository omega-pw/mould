...
const EXTENSION_ID: &str = "mould.mysql";
const EXTENSION_NAME: &str = "mysql数据库";
...
mould_extension_sdk::plugin_implementation!(Extension, MysqlExtension);
