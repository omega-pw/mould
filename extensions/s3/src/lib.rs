...
const EXTENSION_ID: &str = "mould.s3";
const EXTENSION_NAME: &str = "s3对象存储";
...
mould_extension_sdk::plugin_implementation!(Extension, S3Extension);
